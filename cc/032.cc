...
public:
    int NumberOf1Between1AndN_Solution(int n)
    {
         ...
         * 根据设定的整数位置，对n进行分割，分为两部分，a=高位n/i，b=低位n%i。
         ...
         * 综上，当百位对应0或>=2时，有(a+8)/10次包含所有100个点，还有当百位为1(a%10==1)，需要增加局部点b+1。
...
{
    cout << (new Solution())->NumberOf1Between1AndN_Solution(13) << endl;
    return 0;
}
